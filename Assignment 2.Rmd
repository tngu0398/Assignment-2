...
- The scatter plot of deaths from alcohol use disorders vs household alcohol expense shows that the percentage death is about constant at first but then increases exponentially beyond a household alcohol expense of 1.5%. Some of the observed outliers may be a result of the **additional predictors** mentioned above. This scatter plot is also reflective of the death vs consumption scatter plot in Fig B and, therefore, reaffirms that percentage death is dependant on the alcohol consumption per person.

- The above scatter plots also help explain why the Multiple Linear Regression model used explains only 45% of the variation in percentage deaths in alcohol use orders because the relation between the dependant and independant variables does not appear to be linear.
