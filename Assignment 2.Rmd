...
```{r LoadData2, echo = FALSE, warning = FALSE, message = FALSE}
#Load merged data
...
Most of the countries with high death rates are in the subarctic or arctic zones in the northern hemisphere (Figure \@ref(fig:Visual1)). This is in line with findings from Figure \@ref(fig:). The cold and dark climates in these countries might have contributed to this observation.
...
```{r Visual1, fig.cap = "Visual1", echo = FALSE, warning = FALSE, message = FALSE}
# Load world map data
...
#### Plot
```{r Visual_trend, fig.cap= "Visualtrend", echo = FALSE, warning = FALSE, message = FALSE}
...
visual_2_interactive <- ggplotly(visual2) %>%
  layout(title = list(text = paste0("Changes of death from alcohol over 2010-2019",
                                    "<br>",
                                    "<sup>")),
         annotations = list(x = 1, y = -0.1, text = "Data retreived from https://ourworldindata.org/alcohol-consumption.",
                         showarrow = F, xref='paper', yref='paper',
